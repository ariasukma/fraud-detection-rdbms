CREATE TABLE IF NOT EXISTS transactions (
  ...
  device_change_count_24h INTEGER,
  ...
  avg_transaction_amount_30d NUMERIC(18, 2),
  ...
  beneficiary_age_days INTEGER,
  distance_from_last_location_km NUMERIC(12, 2),
  minutes_since_last_transaction INTEGER,
...
CREATE INDEX IF NOT EXISTS idx_transactions_prediction_status ON transactions (prediction_status);
